        ...
        <div class="container">
           <div class ="row">
               <div class="col-md-6">
                ...
                <a href="https://docs.google.com/forms/d/14Y1ahjt_dlBh0M9ssI-7tBANMt-F4XrcvVPShxQQaQI/edit" target="_blank"><button type="button" class="btn btn-primary ">FORM>></button></a>
                 </div>
                 <div class="col-md-6 ">
                <h2>Job Seekers</h2>
...
<div class="container">
    ...
    <div class="img-box">
    <img src="images/pr.jpg" class="img-responsive"> 
    <ul>
    ...
    <a href="#"><li><i class="fa fa-linkedin"></i></li></a>
        ...
        <div class="col-md-3 profile-pic text-center">
    <div class="img-box">
    <img src="images/pr2.jpg" class="img-responsive"> 
    <ul>
    <a href="#"><li><i class="fa fa-twitter"></i></li></a>
    <a href="#"><li><i class="fa fa-linkedin"></i></li></a>
    </ul>
...
<section id="promo">
<div class="container">
    <p>Get 60% off on Domain Name and Web Hosting</p>
    <a href="https://www.hostinger.in/?ppc_campaign=google_search_brand&bidkw=hostinger&lo=9062009&gclid=Cj0KCQiAqo3-BRDoARIsAE5vnaJoi3LKVOk9tfawdzzthdf1f5beEKvBSIl-H86V-SwImvbUdwyOyTEaAslpEALw_wcB" class="btn btn-primary">Contact Us</a>
</div>
</section>
<!--------Testimonials-------->
...
<div class="container">
<h1>Testimonials</h1>
<p class="text-center">--TYPE ANYTHING--</p>
<div class="row">
 <div class="col-md-4 text-center">
    <div class="profile">
    <img src="images/pr.jpg" class="user">
    <blockquote>WONDERFUL SERVICE BY THE TEAM. HAPPY CLIENT!</blockquote>
        <h3>PAVANA <span>Co-Founder at XYZ</span></h3>
    </div>      
 </div>
    <div class="col-md-4 text-center">
    <div class="profile">
    <img src="images/pr2.jpg" class="user">
    <blockquote>WONDERFUL SERVICE BY THE TEAM. HAPPY CLIENT!</blockquote>
        <h3>PRAJWAL <span>Manager at XYZ</span></h3>
    </div>      
 </div>
    <div class="col-md-4 text-center">
    <div class="profile">
    <img src="images/pr2.jpg" class="user">
    <blockquote>WONDERFUL SERVICE BY THE TEAM. HAPPY CLIENT!</blockquote>
        <h3>POOJITHA<span>Founder / CEO at XYZ</span></h3>
    </div>      
 </div>
</div>
</div>
...
<section id="contact">
 <div class="container">
    <h1>Get In Touch</h1>
    <h3>CONTACT US</h3>
     <a href="ind.php" target="_blank"><button type="submit" class="btn btn-primary">SEND MESSAGE</button></a>
    </div>
